"""
Django settings for trafic_risk_detection project.
...
SECRET_KEY = 'django-insecure-!)gj!mnl!0wylyn+q3*euua#3(20(fcaw4ti!xce$jg5%ey^j@'
...
ROOT_URLCONF = 'trafic_risk_detection.urls'
...
WSGI_APPLICATION = 'trafic_risk_detection.wsgi.application'
